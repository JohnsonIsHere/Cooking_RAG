...
- **Latest card report:** [`docs/cards/01-repo-python-env-setup.md`](docs/cards/01-repo-python-env-setup.md) — card 1 fully done, pushed to https://github.com/JohnsonIsHere/Cooking_RAG.
